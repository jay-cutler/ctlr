...
#'
#' @export
scale_color_mff <- function(palette = "Blue", discrete = TRUE, reverse = FALSE, contrast = "high") {
  ...
  if (discrete) {
    ggplot2::discrete_scale("colour", paste0("mff_", palette), palette = grDevices::colorRampPalette(pal))
  } else {
